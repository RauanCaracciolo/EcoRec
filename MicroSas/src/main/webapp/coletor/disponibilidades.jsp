...
<body>
    <div class="container d-flex justify-content-center mt-5 mb-5">
        <div class="card card-container w-100" style="max-width: 800px;">
            <div class="card-body">
                <h3 class="title-text mb-4 text-center">Minhas Disponibilidades</h3>

                <p class="text-center">Bem-vindo, <strong><%=coletor.getNome()%></strong>!</p>

                <div class="mb-4">
                    <h5 class="title-text">Adicionar nova disponibilidade</h5>
                    <form action="<%= request.getContextPath() %>/FrontController" method="post" class="row g-3 justify-content-center">
                        <input type="hidden" name="command" value="RegisterDisponibilidade">
                        <input type="hidden" name="cpf_coletor" value="<%=coletor.getCpf()%>">

                        <div class="col-md-6">
                            <input type="datetime-local" id="horario" name="horario" class="form-control" required>
                        </div>
                        <div class="col-auto">
                ...
                <form action="<%= request.getContextPath() %>/FrontController" method="get" class="text-center mt-4">
    ...
    <script>
            ...
            const minAttr = `${yyyy}-${mm}-${dd}T${hh}:${min}`;
            document.getElementById('horario').min = minAttr;
        })();
    </script>
</body>
</html>
